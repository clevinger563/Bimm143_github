...
>Q Determine if these sequences can be found in nature 
We can get the set of 20 natural amino-acids from the "bio3d"
 package
...
cat(seq.line, sep="\n", file="myseq.fa")
```
>Q: Determine if thse sequences can be found in anture or are they unique? Why or why not?
I BLASTp searched my FAFSTA format sequences against NR and found that length 6,7,8, are not unique and can be found in databases with 100% coverage and 100% identity. 
